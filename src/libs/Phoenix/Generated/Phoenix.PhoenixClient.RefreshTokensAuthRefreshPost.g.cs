...
namespace Phoenix
{
    public partial class PhoenixClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_RefreshTokensAuthRefreshPostSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_RefreshTokensAuthRefreshPostSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_RefreshTokensAuthRefreshPostSecurityRequirement0,
            };
        partial void PrepareRefreshTokensAuthRefreshPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareRefreshTokensAuthRefreshPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessRefreshTokensAuthRefreshPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRefreshTokensAuthRefreshPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> RefreshTokensAuthRefreshPostAsync(
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RefreshTokensAuthRefreshPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<string>> RefreshTokensAuthRefreshPostAsResponseAsync(
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRefreshTokensAuthRefreshPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_RefreshTokensAuthRefreshPostSecurityRequirements,
                operationName: "RefreshTokensAuthRefreshPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRefreshTokensAuthRefreshPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RefreshTokensAuthRefreshPost",
                                methodName: "RefreshTokensAuthRefreshPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRefreshTokensAuthRefreshPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRefreshTokensAuthRefreshPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
