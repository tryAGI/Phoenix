...
namespace Phoenix
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_SetDatasetLabelsForDatasetSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_SetDatasetLabelsForDatasetSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_SetDatasetLabelsForDatasetSecurityRequirement0,
            };
        partial void PrepareSetDatasetLabelsForDatasetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string datasetIdentifier,
            global::Phoenix.SetDatasetLabelsRequestBody request);
        partial void PrepareSetDatasetLabelsForDatasetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string datasetIdentifier,
            global::Phoenix.SetDatasetLabelsRequestBody request);
        partial void ProcessSetDatasetLabelsForDatasetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetDatasetLabelsForDatasetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetDatasetLabelsForDatasetResponseBody> SetDatasetLabelsForDatasetAsync(
            string datasetIdentifier,
        ...
        {
            var __response = await SetDatasetLabelsForDatasetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetDatasetLabelsForDatasetResponseBody>> SetDatasetLabelsForDatasetAsResponseAsync(
            string datasetIdentifier,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetDatasetLabelsForDatasetArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetDatasetLabelsForDatasetSecurityRequirements,
                operationName: "SetDatasetLabelsForDatasetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/datasets/{datasetIdentifier}/labels",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSetDatasetLabelsForDatasetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SetDatasetLabelsForDatasetAsync",
                                pathTemplate: "$\"/v1/datasets/{datasetIdentifier}/labels\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetDatasetLabelsForDatasetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Dataset or one or more dataset labels not found
                            ...
                            // Invalid dataset identifier or request body
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetDatasetLabelsForDatasetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.SetDatasetLabelsForDatasetResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetDatasetLabelsForDatasetResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.SetDatasetLabelsForDatasetResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetDatasetLabelsForDatasetResponseBody> SetDatasetLabelsForDatasetAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.SetDatasetLabelsRequestBody
            {
                DatasetLabelIds = datasetLabelIds,
            };

            return await SetDatasetLabelsForDatasetAsync(
                datasetIdentifier: datasetIdentifier,
                request: __request,
                requestOptions: requestOptions,
