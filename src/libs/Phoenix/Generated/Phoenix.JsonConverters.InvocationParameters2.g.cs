...
{
    /// <inheritdoc />
    public class InvocationParameters2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Phoenix.InvocationParameters2>
    {
        /// <inheritdoc />
        public override global::Phoenix.InvocationParameters2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Phoenix.PromptVersionDataInvocationParametersDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Phoenix.PromptVersionDataInvocationParametersDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Phoenix.PromptVersionDataInvocationParametersDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Phoenix.PromptOpenAIInvocationParameters? openai = default;
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Openai)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.AzureOpenai)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Anthropic)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Google)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Deepseek)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Xai)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Ollama)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Aws)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Cerebras)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Fireworks)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Groq)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Moonshot)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Perplexity)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Together)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Zai)
            {
            ...
            if (discriminator?.Type == global::Phoenix.PromptVersionDataInvocationParametersDiscriminatorType.Meta)
            {
            ...
            var __value = new global::Phoenix.InvocationParameters2(
                discriminator?.Type,
                openai,
        ...
        public override void Write(
            ...
            global::Phoenix.InvocationParameters2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
