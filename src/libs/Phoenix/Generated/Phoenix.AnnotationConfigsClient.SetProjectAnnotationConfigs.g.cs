...
namespace Phoenix
{
    public partial class AnnotationConfigsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_SetProjectAnnotationConfigsSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_SetProjectAnnotationConfigsSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_SetProjectAnnotationConfigsSecurityRequirement0,
            };
        partial void PrepareSetProjectAnnotationConfigsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdentifier,
            global::Phoenix.SetProjectAnnotationConfigsRequestBody request);
        partial void PrepareSetProjectAnnotationConfigsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectIdentifier,
            global::Phoenix.SetProjectAnnotationConfigsRequestBody request);
        partial void ProcessSetProjectAnnotationConfigsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetProjectAnnotationConfigsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetProjectAnnotationConfigsResponseBody> SetProjectAnnotationConfigsAsync(
            string projectIdentifier,
        ...
        {
            var __response = await SetProjectAnnotationConfigsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetProjectAnnotationConfigsResponseBody>> SetProjectAnnotationConfigsAsResponseAsync(
            string projectIdentifier,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetProjectAnnotationConfigsArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetProjectAnnotationConfigsSecurityRequirements,
                operationName: "SetProjectAnnotationConfigsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/projects/{projectIdentifier}/annotation_configs",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSetProjectAnnotationConfigsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SetProjectAnnotationConfigsAsync",
                                pathTemplate: "$\"/v1/projects/{projectIdentifier}/annotation_configs\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetProjectAnnotationConfigsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetProjectAnnotationConfigsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.SetProjectAnnotationConfigsResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetProjectAnnotationConfigsResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.SetProjectAnnotationConfigsResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetProjectAnnotationConfigsResponseBody> SetProjectAnnotationConfigsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.SetProjectAnnotationConfigsRequestBody
            {
                AnnotationConfigIds = annotationConfigIds,
            };

            return await SetProjectAnnotationConfigsAsync(
                projectIdentifier: projectIdentifier,
                request: __request,
                requestOptions: requestOptions,
