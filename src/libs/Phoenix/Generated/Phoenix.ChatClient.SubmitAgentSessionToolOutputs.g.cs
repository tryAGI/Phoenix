...
namespace Phoenix
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_SubmitAgentSessionToolOutputsSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_SubmitAgentSessionToolOutputsSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_SubmitAgentSessionToolOutputsSecurityRequirement0,
            };
        partial void PrepareSubmitAgentSessionToolOutputsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::Phoenix.SubmitAgentSessionToolOutputsRequestBody request);
        partial void PrepareSubmitAgentSessionToolOutputsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::Phoenix.SubmitAgentSessionToolOutputsRequestBody request);
        partial void ProcessSubmitAgentSessionToolOutputsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitAgentSessionToolOutputsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SubmitAgentSessionToolOutputsResponseBody> SubmitAgentSessionToolOutputsAsync(
            string sessionId,
        ...
        {
            var __response = await SubmitAgentSessionToolOutputsAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SubmitAgentSessionToolOutputsResponseBody>> SubmitAgentSessionToolOutputsAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitAgentSessionToolOutputsArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitAgentSessionToolOutputsSecurityRequirements,
                operationName: "SubmitAgentSessionToolOutputsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/agent_sessions/{sessionId}/tool_outputs",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitAgentSessionToolOutputsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitAgentSessionToolOutputsAsync",
                                pathTemplate: "$\"/v1/agent_sessions/{sessionId}/tool_outputs\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitAgentSessionToolOutputsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The request conflicts with the session's current state; the body's ``code`` field says how.
                            if ((int)__response.StatusCode == 409)
                            {
                                string? __content_409 = null;
                                global::System.Exception? __exception_409 = null;
                                global::Phoenix.AgentSessionConflictError? __value_409 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_409 = global::Phoenix.AgentSessionConflictError.FromJson(__content_409, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_409 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Phoenix.ApiException<global::Phoenix.AgentSessionConflictError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitAgentSessionToolOutputsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.SubmitAgentSessionToolOutputsResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SubmitAgentSessionToolOutputsResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.SubmitAgentSessionToolOutputsResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SubmitAgentSessionToolOutputsResponseBody> SubmitAgentSessionToolOutputsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.SubmitAgentSessionToolOutputsRequestBody
            {
                ToolOutputs = toolOutputs,
                LastMessageId = lastMessageId,
            };

            return await SubmitAgentSessionToolOutputsAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
