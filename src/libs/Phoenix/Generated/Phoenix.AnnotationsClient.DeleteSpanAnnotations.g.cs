...
namespace Phoenix
{
    public partial class AnnotationsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_DeleteSpanAnnotationsSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_DeleteSpanAnnotationsSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_DeleteSpanAnnotationsSecurityRequirement0,
            };
        partial void PrepareDeleteSpanAnnotationsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdentifier,
            ref string? name,
            ref string? identifier,
            ref global::Phoenix.DeleteSpanAnnotationsAnnotatorKind? annotatorKind,
            global::System.DateTime? startTime,
            global::System.DateTime? endTime,
            ref bool? deleteAll);
        partial void PrepareDeleteSpanAnnotationsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectIdentifier,
            string? name,
            string? identifier,
            global::Phoenix.DeleteSpanAnnotationsAnnotatorKind? annotatorKind,
            global::System.DateTime? startTime,
            global::System.DateTime? endTime,
            bool? deleteAll);
        partial void ProcessDeleteSpanAnnotationsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteSpanAnnotationsAsync(
            string projectIdentifier,
            string? name = default,
            string? identifier = default,
            global::Phoenix.DeleteSpanAnnotationsAnnotatorKind? annotatorKind = default,
        ...
        {
            await DeleteSpanAnnotationsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse> DeleteSpanAnnotationsAsResponseAsync(
            string projectIdentifier,
            string? name = default,
            string? identifier = default,
            global::Phoenix.DeleteSpanAnnotationsAnnotatorKind? annotatorKind = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteSpanAnnotationsArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteSpanAnnotationsSecurityRequirements,
                operationName: "DeleteSpanAnnotationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteSpanAnnotationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "DeleteSpanAnnotationsAsync",
                                pathTemplate: "$\"/v1/projects/{projectIdentifier}/span_annotations\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteSpanAnnotationsResponse(
                    httpClient: HttpClient,
