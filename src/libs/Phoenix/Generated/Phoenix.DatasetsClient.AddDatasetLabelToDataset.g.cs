...
namespace Phoenix
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_AddDatasetLabelToDatasetSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_AddDatasetLabelToDatasetSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_AddDatasetLabelToDatasetSecurityRequirement0,
            };
        partial void PrepareAddDatasetLabelToDatasetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string datasetIdentifier,
            ref string labelId);
        partial void PrepareAddDatasetLabelToDatasetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string datasetIdentifier,
            string labelId);
        partial void ProcessAddDatasetLabelToDatasetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddDatasetLabelToDatasetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.AddDatasetLabelToDatasetResponseBody> AddDatasetLabelToDatasetAsync(
            string datasetIdentifier,
            string labelId,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AddDatasetLabelToDatasetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.AddDatasetLabelToDatasetResponseBody>> AddDatasetLabelToDatasetAsResponseAsync(
            string datasetIdentifier,
            string labelId,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAddDatasetLabelToDatasetArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddDatasetLabelToDatasetSecurityRequirements,
                operationName: "AddDatasetLabelToDatasetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/datasets/{datasetIdentifier}/labels/{labelId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAddDatasetLabelToDatasetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddDatasetLabelToDatasetAsync",
                                pathTemplate: "$\"/v1/datasets/{datasetIdentifier}/labels/{labelId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddDatasetLabelToDatasetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Dataset or dataset label not found
                            ...
                            // Invalid dataset identifier or dataset label ID
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddDatasetLabelToDatasetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.AddDatasetLabelToDatasetResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.AddDatasetLabelToDatasetResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.AddDatasetLabelToDatasetResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
