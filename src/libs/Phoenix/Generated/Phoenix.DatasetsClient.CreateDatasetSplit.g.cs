...
namespace Phoenix
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_CreateDatasetSplitSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_CreateDatasetSplitSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_CreateDatasetSplitSecurityRequirement0,
            };
        partial void PrepareCreateDatasetSplitArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string datasetIdentifier,
            global::Phoenix.CreateDatasetSplitRequestBody request);
        partial void PrepareCreateDatasetSplitRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string datasetIdentifier,
            global::Phoenix.CreateDatasetSplitRequestBody request);
        partial void ProcessCreateDatasetSplitResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDatasetSplitResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.CreateDatasetSplitResponseBody> CreateDatasetSplitAsync(
            string datasetIdentifier,
        ...
        {
            var __response = await CreateDatasetSplitAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.CreateDatasetSplitResponseBody>> CreateDatasetSplitAsResponseAsync(
            string datasetIdentifier,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDatasetSplitArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDatasetSplitSecurityRequirements,
                operationName: "CreateDatasetSplitAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDatasetSplitRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateDatasetSplitAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDatasetSplitResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDatasetSplitResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.CreateDatasetSplitResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.CreateDatasetSplitResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.CreateDatasetSplitResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.CreateDatasetSplitResponseBody> CreateDatasetSplitAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.CreateDatasetSplitRequestBody
            {
                Name = name,
            ...
            return await CreateDatasetSplitAsync(
                datasetIdentifier: datasetIdentifier,
                request: __request,
                requestOptions: requestOptions,
