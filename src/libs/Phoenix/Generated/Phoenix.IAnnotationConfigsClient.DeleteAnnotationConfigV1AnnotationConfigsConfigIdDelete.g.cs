...
namespace Phoenix
{
    public partial interface IAnnotationConfigsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.DeleteAnnotationConfigResponseBody>> DeleteAnnotationConfigV1AnnotationConfigsConfigIdDeleteAsResponseAsync(
            string configId,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
