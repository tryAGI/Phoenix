...
namespace Phoenix
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_CompactAgentSessionSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_CompactAgentSessionSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_CompactAgentSessionSecurityRequirement0,
            };
        partial void PrepareCompactAgentSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId,
            global::Phoenix.CompactAgentSessionRequestBody request);
        partial void PrepareCompactAgentSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            global::Phoenix.CompactAgentSessionRequestBody request);
        partial void ProcessCompactAgentSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCompactAgentSessionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.CompactAgentSessionResponseBody> CompactAgentSessionAsync(
            string sessionId,
        ...
        {
            var __response = await CompactAgentSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.CompactAgentSessionResponseBody>> CompactAgentSessionAsResponseAsync(
            string sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCompactAgentSessionArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CompactAgentSessionSecurityRequirements,
                operationName: "CompactAgentSessionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/agent_sessions/{sessionId}/compact",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCompactAgentSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CompactAgentSessionAsync",
                                pathTemplate: "$\"/v1/agent_sessions/{sessionId}/compact\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCompactAgentSessionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCompactAgentSessionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.CompactAgentSessionResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.CompactAgentSessionResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.CompactAgentSessionResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.CompactAgentSessionResponseBody> CompactAgentSessionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.CompactAgentSessionRequestBody
            {
                Model = model,
            };

            return await CompactAgentSessionAsync(
                sessionId: sessionId,
                request: __request,
                requestOptions: requestOptions,
