...
namespace Phoenix
{
    ...
    public sealed partial class PydanticAiUiVercelAiRequestTypesToolOutputErrorPart
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PydanticAiUiVercelAiRequestTypesToolOutputErrorPart" /> class.
        /// </summary>
...
#endif
        public PydanticAiUiVercelAiRequestTypesToolOutputErrorPart(
            string type,
            string toolCallId,
            string errorText,
            string? title,
