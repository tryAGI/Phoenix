...
namespace Phoenix
{
    ...
    public sealed partial class PydanticAiUiVercelAiRequestTypesDynamicToolOutputErrorPart
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PydanticAiUiVercelAiRequestTypesDynamicToolOutputErrorPart" /> class.
        /// </summary>
...
#endif
        public PydanticAiUiVercelAiRequestTypesDynamicToolOutputErrorPart(
            string toolName,
            string toolCallId,
            object input,
            string errorText,
