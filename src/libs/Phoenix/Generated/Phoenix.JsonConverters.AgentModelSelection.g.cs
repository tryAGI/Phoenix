...
{
    /// <inheritdoc />
    public class AgentModelSelectionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Phoenix.AgentModelSelection>
    {
        /// <inheritdoc />
        public override global::Phoenix.AgentModelSelection Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Phoenix.AgentModelSelectionDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Phoenix.AgentModelSelectionDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Phoenix.AgentModelSelectionDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Phoenix.CustomProviderModelSelection? custom = default;
            if (discriminator?.ProviderType == global::Phoenix.AgentModelSelectionDiscriminatorProviderType.Custom)
            {
            ...
            if (discriminator?.ProviderType == global::Phoenix.AgentModelSelectionDiscriminatorProviderType.Builtin)
            {
            ...
            var __value = new global::Phoenix.AgentModelSelection(
        ...
        public override void Write(
            ...
            global::Phoenix.AgentModelSelection value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
