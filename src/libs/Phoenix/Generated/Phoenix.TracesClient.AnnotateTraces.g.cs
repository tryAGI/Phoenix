...
namespace Phoenix
{
    public partial class TracesClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_AnnotateTracesSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_AnnotateTracesSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_AnnotateTracesSecurityRequirement0,
            };
        partial void PrepareAnnotateTracesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? sync,
            global::Phoenix.AnnotateTracesRequestBody request);
        partial void PrepareAnnotateTracesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? sync,
            global::Phoenix.AnnotateTracesRequestBody request);
        partial void ProcessAnnotateTracesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAnnotateTracesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.AnnotateTracesResponseBody> AnnotateTracesAsync(
        ...
        {
            var __response = await AnnotateTracesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.AnnotateTracesResponseBody>> AnnotateTracesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAnnotateTracesArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AnnotateTracesSecurityRequirements,
                operationName: "AnnotateTracesAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AnnotateTracesAsync",
                                pathTemplate: "\"/v1/trace_annotations\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAnnotateTracesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.AnnotateTracesResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.AnnotateTracesResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.AnnotateTracesResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.AnnotateTracesResponseBody> AnnotateTracesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.AnnotateTracesRequestBody
            {
                Data = data,
            };

            return await AnnotateTracesAsync(
                sync: sync,
                request: __request,
                requestOptions: requestOptions,
