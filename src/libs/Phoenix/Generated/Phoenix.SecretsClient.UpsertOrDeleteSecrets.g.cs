...
namespace Phoenix
{
    public partial class SecretsClient
    {
        ...
        {
            var __response = await UpsertOrDeleteSecretsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.ResponseBodyUpsertOrDeleteSecretsResult>> UpsertOrDeleteSecretsAsResponseAsync(
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.ResponseBodyUpsertOrDeleteSecretsResult.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.ResponseBodyUpsertOrDeleteSecretsResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.ResponseBodyUpsertOrDeleteSecretsResult.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
