...
namespace Phoenix
{
    public partial class ExperimentsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_UpdateExperimentSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_UpdateExperimentSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_UpdateExperimentSecurityRequirement0,
            };
        partial void PrepareUpdateExperimentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string experimentId,
            global::Phoenix.UpdateExperimentRequestBody request);
        partial void PrepareUpdateExperimentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string experimentId,
            global::Phoenix.UpdateExperimentRequestBody request);
        partial void ProcessUpdateExperimentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateExperimentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.UpdateExperimentResponseBody> UpdateExperimentAsync(
            string experimentId,
        ...
        {
            var __response = await UpdateExperimentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.UpdateExperimentResponseBody>> UpdateExperimentAsResponseAsync(
            string experimentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateExperimentArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateExperimentSecurityRequirements,
                operationName: "UpdateExperimentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateExperimentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateExperimentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateExperimentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid experiment ID or request body
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateExperimentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.UpdateExperimentResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.UpdateExperimentResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.UpdateExperimentResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.UpdateExperimentResponseBody> UpdateExperimentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.UpdateExperimentRequestBody
            {
                Name = name,
            ...
            return await UpdateExperimentAsync(
                experimentId: experimentId,
                request: __request,
                requestOptions: requestOptions,
