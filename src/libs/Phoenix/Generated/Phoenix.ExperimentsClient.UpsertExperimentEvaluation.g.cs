...
namespace Phoenix
{
    public partial class ExperimentsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_UpsertExperimentEvaluationSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_UpsertExperimentEvaluationSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_UpsertExperimentEvaluationSecurityRequirement0,
            };
        partial void PrepareUpsertExperimentEvaluationArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Phoenix.UpsertExperimentEvaluationRequestBody request);
        partial void PrepareUpsertExperimentEvaluationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Phoenix.UpsertExperimentEvaluationRequestBody request);
        partial void ProcessUpsertExperimentEvaluationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpsertExperimentEvaluationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.UpsertExperimentEvaluationResponseBody> UpsertExperimentEvaluationAsync(

            global::Phoenix.UpsertExperimentEvaluationRequestBody request,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UpsertExperimentEvaluationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.UpsertExperimentEvaluationResponseBody>> UpsertExperimentEvaluationAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpsertExperimentEvaluationArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpsertExperimentEvaluationSecurityRequirements,
                operationName: "UpsertExperimentEvaluationAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpsertExperimentEvaluationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpsertExperimentEvaluationAsync",
                                pathTemplate: "\"/v1/experiment_evaluations\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpsertExperimentEvaluationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpsertExperimentEvaluationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.UpsertExperimentEvaluationResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.UpsertExperimentEvaluationResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.UpsertExperimentEvaluationResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.UpsertExperimentEvaluationResponseBody> UpsertExperimentEvaluationAsync(
            ...
            string name,
            global::Phoenix.UpsertExperimentEvaluationRequestBodyAnnotatorKind annotatorKind,
            global::System.DateTime startTime,
            global::System.DateTime endTime,
            global::Phoenix.ExperimentEvaluationResult? result = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.UpsertExperimentEvaluationRequestBody
            {
            ...
            return await UpsertExperimentEvaluationAsync(
                request: __request,
                requestOptions: requestOptions,
