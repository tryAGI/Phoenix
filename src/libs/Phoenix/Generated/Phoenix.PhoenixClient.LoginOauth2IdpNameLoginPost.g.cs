...
namespace Phoenix
{
    public partial class PhoenixClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_LoginOauth2IdpNameLoginPostSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_LoginOauth2IdpNameLoginPostSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_LoginOauth2IdpNameLoginPostSecurityRequirement0,
            };
        partial void PrepareLoginOauth2IdpNameLoginPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string idpName,
            ref string? returnUrl);
        partial void PrepareLoginOauth2IdpNameLoginPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string idpName,
            string? returnUrl);
        partial void ProcessLoginOauth2IdpNameLoginPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLoginOauth2IdpNameLoginPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> LoginOauth2IdpNameLoginPostAsync(
            string idpName,
            string? returnUrl = default,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LoginOauth2IdpNameLoginPostAsResponseAsync(
                idpName: idpName,
                returnUrl: returnUrl,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<string>> LoginOauth2IdpNameLoginPostAsResponseAsync(
            string idpName,
            string? returnUrl = default,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareLoginOauth2IdpNameLoginPostArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_LoginOauth2IdpNameLoginPostSecurityRequirements,
                operationName: "LoginOauth2IdpNameLoginPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/oauth2/{idpName}/login",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("returnUrl", returnUrl)
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLoginOauth2IdpNameLoginPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LoginOauth2IdpNameLoginPost",
                                methodName: "LoginOauth2IdpNameLoginPostAsync",
                                pathTemplate: "$\"/oauth2/{idpName}/login\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessLoginOauth2IdpNameLoginPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLoginOauth2IdpNameLoginPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
