...
namespace Phoenix
{
    ...
    public sealed partial class UIMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Phoenix.JsonConverters.UIMessageRoleJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Phoenix.UIMessageRole Role { get; set; }
        ...
        public UIMessage(
            string id,
            global::Phoenix.UIMessageRole role,
