...
namespace Phoenix
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_UpdateDatasetSplitSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_UpdateDatasetSplitSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_UpdateDatasetSplitSecurityRequirement0,
            };
        partial void PrepareUpdateDatasetSplitArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string datasetIdentifier,
            ref string splitId,
            global::Phoenix.UpdateDatasetSplitRequestBody request);
        partial void PrepareUpdateDatasetSplitRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string datasetIdentifier,
            string splitId,
            global::Phoenix.UpdateDatasetSplitRequestBody request);
        partial void ProcessUpdateDatasetSplitResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateDatasetSplitResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.UpdateDatasetSplitResponseBody> UpdateDatasetSplitAsync(
            string datasetIdentifier,
            string splitId,
        ...
        {
            var __response = await UpdateDatasetSplitAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.UpdateDatasetSplitResponseBody>> UpdateDatasetSplitAsResponseAsync(
            string datasetIdentifier,
            string splitId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateDatasetSplitArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateDatasetSplitSecurityRequirements,
                operationName: "UpdateDatasetSplitAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/datasets/{datasetIdentifier}/splits/{splitId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateDatasetSplitRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateDatasetSplitAsync",
                                pathTemplate: "$\"/v1/datasets/{datasetIdentifier}/splits/{splitId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateDatasetSplitResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Dataset, split, or example not found
                            ...
                            // A dataset split with the given name already exists
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateDatasetSplitResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.UpdateDatasetSplitResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.UpdateDatasetSplitResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.UpdateDatasetSplitResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.UpdateDatasetSplitResponseBody> UpdateDatasetSplitAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.UpdateDatasetSplitRequestBody
            {
                Name = name,
                Description = description,
                Color = color,
                Metadata = metadata,
                AddExampleIds = addExampleIds,
                RemoveExampleIds = removeExampleIds,
            };

            return await UpdateDatasetSplitAsync(
                datasetIdentifier: datasetIdentifier,
                splitId: splitId,
                request: __request,
                requestOptions: requestOptions,
