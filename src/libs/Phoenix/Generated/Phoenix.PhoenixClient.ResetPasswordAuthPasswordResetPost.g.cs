...
namespace Phoenix
{
    public partial class PhoenixClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_ResetPasswordAuthPasswordResetPostSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_ResetPasswordAuthPasswordResetPostSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_ResetPasswordAuthPasswordResetPostSecurityRequirement0,
            };
        partial void PrepareResetPasswordAuthPasswordResetPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareResetPasswordAuthPasswordResetPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessResetPasswordAuthPasswordResetPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResetPasswordAuthPasswordResetPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ResetPasswordAuthPasswordResetPostAsync(
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ResetPasswordAuthPasswordResetPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<string>> ResetPasswordAuthPasswordResetPostAsResponseAsync(
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareResetPasswordAuthPasswordResetPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ResetPasswordAuthPasswordResetPostSecurityRequirements,
                operationName: "ResetPasswordAuthPasswordResetPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareResetPasswordAuthPasswordResetPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ResetPasswordAuthPasswordResetPost",
                                methodName: "ResetPasswordAuthPasswordResetPostAsync",
                                pathTemplate: "\"/auth/password-reset\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessResetPasswordAuthPasswordResetPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessResetPasswordAuthPasswordResetPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
