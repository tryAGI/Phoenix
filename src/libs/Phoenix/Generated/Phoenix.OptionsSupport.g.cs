...
namespace Phoenix
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Phoenix.AutoSDKRetryOptions Retry { get; set; } = new global::Phoenix.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Phoenix.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Phoenix.IAutoSDKHook>();
        ...
        public global::Phoenix.AutoSDKClientOptions AddHook(
            global::Phoenix.IAutoSDKHook hook)
        {
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Phoenix.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    public sealed class AutoSDKAuthorizationProviderHook : global::Phoenix.AutoSDKHook
    {
            ...
            global::Phoenix.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Phoenix.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Phoenix.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Phoenix.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Phoenix.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Phoenix.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Phoenix.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Phoenix.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Phoenix.AutoSDKClientOptions clientOptions,
            global::Phoenix.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Phoenix.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Phoenix.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Phoenix.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Phoenix.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Phoenix.IAutoSDKHook, global::Phoenix.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Phoenix.AutoSDKHookContext context)
        {
