...
namespace Phoenix
{
    public partial class TracesClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_TransferTracesSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_TransferTracesSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_TransferTracesSecurityRequirement0,
            };
        partial void PrepareTransferTracesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Phoenix.TransferTracesRequestBody request);
        partial void PrepareTransferTracesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Phoenix.TransferTracesRequestBody request);
        partial void ProcessTransferTracesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTransferTracesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.TransferTracesResponseBody> TransferTracesAsync(

            global::Phoenix.TransferTracesRequestBody request,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TransferTracesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.TransferTracesResponseBody>> TransferTracesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTransferTracesArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TransferTracesSecurityRequirements,
                operationName: "TransferTracesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "TransferTracesAsync",
                                pathTemplate: "\"/v1/traces/transfer\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Destination project or trace not found
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTransferTracesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.TransferTracesResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.TransferTracesResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.TransferTracesResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.TransferTracesResponseBody> TransferTracesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.TransferTracesRequestBody
            {
                TraceIdentifiers = traceIdentifiers,
                DestinationProjectIdentifier = destinationProjectIdentifier,
            };

            return await TransferTracesAsync(
                request: __request,
                requestOptions: requestOptions,
