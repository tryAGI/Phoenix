...
namespace Phoenix
{
    public partial class AnnotationConfigsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_GetProjectAnnotationConfigsSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_GetProjectAnnotationConfigsSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_GetProjectAnnotationConfigsSecurityRequirement0,
            };
        partial void PrepareGetProjectAnnotationConfigsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdentifier,
            ref string? cursor,
            ref int? limit);
        partial void PrepareGetProjectAnnotationConfigsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectIdentifier,
            string? cursor,
            int? limit);
        partial void ProcessGetProjectAnnotationConfigsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectAnnotationConfigsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.GetProjectAnnotationConfigsResponseBody> GetProjectAnnotationConfigsAsync(
            string projectIdentifier,
        ...
        {
            var __response = await GetProjectAnnotationConfigsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.GetProjectAnnotationConfigsResponseBody>> GetProjectAnnotationConfigsAsResponseAsync(
            string projectIdentifier,
            string? cursor = default,
            int? limit = default,
            global::Phoenix.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectAnnotationConfigsArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetProjectAnnotationConfigsSecurityRequirements,
                operationName: "GetProjectAnnotationConfigsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetProjectAnnotationConfigsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectAnnotationConfigsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectAnnotationConfigsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectAnnotationConfigsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.GetProjectAnnotationConfigsResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.GetProjectAnnotationConfigsResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.GetProjectAnnotationConfigsResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
