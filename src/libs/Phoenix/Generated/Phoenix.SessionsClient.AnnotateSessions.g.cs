...
namespace Phoenix
{
    public partial class SessionsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_AnnotateSessionsSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_AnnotateSessionsSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_AnnotateSessionsSecurityRequirement0,
            };
        partial void PrepareAnnotateSessionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? sync,
            global::Phoenix.AnnotateSessionsRequestBody request);
        partial void PrepareAnnotateSessionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? sync,
            global::Phoenix.AnnotateSessionsRequestBody request);
        partial void ProcessAnnotateSessionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAnnotateSessionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.AnnotateSessionsResponseBody> AnnotateSessionsAsync(
        ...
        {
            var __response = await AnnotateSessionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.AnnotateSessionsResponseBody>> AnnotateSessionsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAnnotateSessionsArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AnnotateSessionsSecurityRequirements,
                operationName: "AnnotateSessionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAnnotateSessionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AnnotateSessionsAsync",
                                pathTemplate: "\"/v1/session_annotations\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAnnotateSessionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAnnotateSessionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.AnnotateSessionsResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.AnnotateSessionsResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.AnnotateSessionsResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.AnnotateSessionsResponseBody> AnnotateSessionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.AnnotateSessionsRequestBody
            {
                Data = data,
            };

            return await AnnotateSessionsAsync(
                sync: sync,
                request: __request,
                requestOptions: requestOptions,
