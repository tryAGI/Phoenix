...
{
    /// <inheritdoc />
    public class DataItem4JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Phoenix.DataItem4>
    {
        /// <inheritdoc />
        public override global::Phoenix.DataItem4 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Phoenix.SetProjectAnnotationConfigsResponseBodyDataItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Phoenix.SetProjectAnnotationConfigsResponseBodyDataItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Phoenix.SetProjectAnnotationConfigsResponseBodyDataItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Phoenix.CategoricalAnnotationConfig? categorical = default;
            if (discriminator?.Type == global::Phoenix.SetProjectAnnotationConfigsResponseBodyDataItemDiscriminatorType.Categorical)
            {
            ...
            if (discriminator?.Type == global::Phoenix.SetProjectAnnotationConfigsResponseBodyDataItemDiscriminatorType.Continuous)
            {
            ...
            if (discriminator?.Type == global::Phoenix.SetProjectAnnotationConfigsResponseBodyDataItemDiscriminatorType.Freeform)
            {
            ...
            var __value = new global::Phoenix.DataItem4(
                discriminator?.Type,
                categorical,
        ...
        public override void Write(
            ...
            global::Phoenix.DataItem4 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
