...
namespace Phoenix
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_SetProjectRetentionPolicySecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_SetProjectRetentionPolicySecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_SetProjectRetentionPolicySecurityRequirement0,
            };
        partial void PrepareSetProjectRetentionPolicyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectIdentifier,
            global::Phoenix.SetProjectRetentionPolicyRequestBody request);
        partial void PrepareSetProjectRetentionPolicyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectIdentifier,
            global::Phoenix.SetProjectRetentionPolicyRequestBody request);
        partial void ProcessSetProjectRetentionPolicyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetProjectRetentionPolicyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetProjectRetentionPolicyResponseBody> SetProjectRetentionPolicyAsync(
            string projectIdentifier,
        ...
        {
            var __response = await SetProjectRetentionPolicyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetProjectRetentionPolicyResponseBody>> SetProjectRetentionPolicyAsResponseAsync(
            string projectIdentifier,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetProjectRetentionPolicyArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetProjectRetentionPolicySecurityRequirements,
                operationName: "SetProjectRetentionPolicyAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/projects/{projectIdentifier}/retention",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSetProjectRetentionPolicyRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SetProjectRetentionPolicy",
                                methodName: "SetProjectRetentionPolicyAsync",
                                pathTemplate: "$\"/v1/projects/{projectIdentifier}/retention\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetProjectRetentionPolicyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetProjectRetentionPolicyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.SetProjectRetentionPolicyResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetProjectRetentionPolicyResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.SetProjectRetentionPolicyResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetProjectRetentionPolicyResponseBody> SetProjectRetentionPolicyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.SetProjectRetentionPolicyRequestBody
            {
                PolicyId = policyId,
            };

            return await SetProjectRetentionPolicyAsync(
                projectIdentifier: projectIdentifier,
                request: __request,
                requestOptions: requestOptions,
