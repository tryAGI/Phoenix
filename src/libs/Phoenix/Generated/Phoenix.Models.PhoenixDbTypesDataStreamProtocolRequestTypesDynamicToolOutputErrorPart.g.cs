...
namespace Phoenix
{
    ...
    public sealed partial class PhoenixDbTypesDataStreamProtocolRequestTypesDynamicToolOutputErrorPart
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoenixDbTypesDataStreamProtocolRequestTypesDynamicToolOutputErrorPart" /> class.
        /// </summary>
...
#endif
        public PhoenixDbTypesDataStreamProtocolRequestTypesDynamicToolOutputErrorPart(
            string toolName,
            string toolCallId,
            object input,
            string errorText,
