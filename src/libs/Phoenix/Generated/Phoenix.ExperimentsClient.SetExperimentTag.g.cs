...
namespace Phoenix
{
    public partial class ExperimentsClient
    {
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement s_SetExperimentTagSecurityRequirement0 =
        ...
        private static readonly global::Phoenix.EndPointSecurityRequirement[] s_SetExperimentTagSecurityRequirements =
            new global::Phoenix.EndPointSecurityRequirement[]
            {                s_SetExperimentTagSecurityRequirement0,
            };
        partial void PrepareSetExperimentTagArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string experimentId,
            global::Phoenix.SetExperimentTagRequestBody request);
        partial void PrepareSetExperimentTagRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string experimentId,
            global::Phoenix.SetExperimentTagRequestBody request);
        partial void ProcessSetExperimentTagResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetExperimentTagResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetExperimentTagResponseBody> SetExperimentTagAsync(
            string experimentId,
        ...
        {
            var __response = await SetExperimentTagAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Phoenix.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetExperimentTagResponseBody>> SetExperimentTagAsResponseAsync(
            string experimentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetExperimentTagArguments(
            ...
            var __authorizations = global::Phoenix.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SetExperimentTagSecurityRequirements,
                operationName: "SetExperimentTagAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Phoenix.PathBuilder(
                                path: $"/v1/experiments/{experimentId}/tags",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSetExperimentTagRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Phoenix.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SetExperimentTagAsync",
                                pathTemplate: "$\"/v1/experiments/{experimentId}/tags\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetExperimentTagResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Phoenix.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Invalid experiment ID or request body, or the experiment is ephemeral and cannot be tagged as the baseline
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetExperimentTagResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Phoenix.SetExperimentTagResponseBody.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Phoenix.AutoSDKHttpResponse<global::Phoenix.SetExperimentTagResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Phoenix.SetExperimentTagResponseBody.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Phoenix.SetExperimentTagResponseBody> SetExperimentTagAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Phoenix.SetExperimentTagRequestBody
            {
                Name = name,
                Description = description,
            };

            return await SetExperimentTagAsync(
                experimentId: experimentId,
                request: __request,
                requestOptions: requestOptions,
