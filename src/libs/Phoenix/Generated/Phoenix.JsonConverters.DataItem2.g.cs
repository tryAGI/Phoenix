...
namespace Phoenix.JsonConverters
{
    ...
    public class DataItem2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Phoenix.DataItem2>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Phoenix.GetUsersResponseBodyDataItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Phoenix.GetUsersResponseBodyDataItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Phoenix.GetUsersResponseBodyDataItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Phoenix.LocalUser? local = default;
            if (discriminator?.AuthMethod == global::Phoenix.GetUsersResponseBodyDataItemDiscriminatorAuthMethod.Local)
            {
            ...
            if (discriminator?.AuthMethod == global::Phoenix.GetUsersResponseBodyDataItemDiscriminatorAuthMethod.Oauth2)
            {
            ...
            if (discriminator?.AuthMethod == global::Phoenix.GetUsersResponseBodyDataItemDiscriminatorAuthMethod.Ldap)
            {
