...
namespace Phoenix
{
    ...
    public sealed partial class PydanticAiUiVercelAiRequestTypesToolOutputAvailablePart
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PydanticAiUiVercelAiRequestTypesToolOutputAvailablePart" /> class.
        /// </summary>
...
#endif
        public PydanticAiUiVercelAiRequestTypesToolOutputAvailablePart(
            string type,
            string toolCallId,
            string? title,
            string? state,
