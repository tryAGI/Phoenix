...
namespace Phoenix
{
    ...
    public sealed partial class PydanticAiUiVercelAiRequestTypesDynamicToolOutputAvailablePart
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PydanticAiUiVercelAiRequestTypesDynamicToolOutputAvailablePart" /> class.
        /// </summary>
...
#endif
        public PydanticAiUiVercelAiRequestTypesDynamicToolOutputAvailablePart(
            string toolName,
            string toolCallId,
            object input,
            object output,
